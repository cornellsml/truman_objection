...
$(window).on("load", async function() {
    ...
    //     let nextPost;
    //     $('.ui.card.videopost').each(function(i, el) {
    //         if ($(this).isInViewport()) {
    //             const nextPost = parseInt($(this)[0].id) + 1;
    //             return false;
    //         }
    //     })
    //     $(`.ui.card.videopost#${nextPost}`)[0].scrollIntoView({
    //         behavior: "smooth",
    //         block: "center"
    //     });
    // });
    ...
    // $(window).scroll(function() {
    //     $(`.ui.card.videopost#2`)[0].scrollIntoView({
    //         behavior: "smooth",
    //         block: "center"
    //     });
    // });
